...
import { Card, Row, Col, Typography, Radio, Spin, Avatar, Tag, Statistic, Space, Badge } from 'antd'
...
export default function Analytics() {
    ...
    }, [period, activePOIId]) // re-fetch when vendor switches shop
    ...
    return (
        <div style={{ padding: '0 0 24px 0', animation: 'fadeIn 0.4s ease-out' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 16 }}>
                <Title level={4} style={{ margin: 0 }}>{isVendor ? 'My Shop Analytics' : 'Analytics'}</Title>
