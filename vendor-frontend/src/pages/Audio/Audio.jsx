        ...
        <div style={{ padding: '0 0 24px 0', animation: 'fadeIn 0.4s ease-out' }}>
            ...
            <Row gutter={[24, 24]} style={{ position: 'relative' }}>
                <Col xs={24} xl={showTTS ? 16 : 24} style={{ transition: 'all 0.3s' }}>
                    ...
                    <Card title={<span><AudioOutlined /> Narration Audio <Badge count={filtered.length} style={{ backgroundColor: '#2563eb', marginLeft: 8 }} /></span>} variant="borderless" style={{ borderRadius: 12, boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
                        <Table 
                            columns={columns} 
                            dataSource={filtered} 
                            rowKey="id" 
                ...
                <Col
                    ...
                    aria-hidden={!showTTS}
                >
                        <Card title={<Space><RobotOutlined style={{ color: '#2563eb' }} /><span>Generate Auto TTS</span></Space>} variant="borderless" style={{ borderRadius: 12, boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', position: 'sticky', top: 24 }} extra={<Button type="text" onClick={() => setShowTTS(false)}>✕</Button>}>
