...
/// <summary>
/// Pluggable transactional email. Default implementation is a no-op; replace with SMTP/SendGrid in production.
/// </summary>
public interface IEmailSender
{
    /// <summary>
    /// Sends a password-reset message containing <paramref name="resetLinkOrAbsoluteUrl"/>.
    /// Returns <c>true</c> if the message was handed off to an external provider.
    /// </summary>
    Task<bool> TrySendPasswordResetAsync(string toEmail, string resetLinkOrAbsoluteUrl, CancellationToken cancellationToken = default);
}
