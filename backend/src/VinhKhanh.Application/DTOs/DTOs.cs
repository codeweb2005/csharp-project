...
/// <summary>POST /api/v1/auth/forgot-password — request a password reset for Customer/Vendor accounts.</summary>
public class ForgotPasswordRequest
{
    public string Email { get; set; } = string.Empty;
}

/// <summary>POST /api/v1/auth/reset-password — complete reset using the token from email (or dev response).</summary>
...
/// <summary>Response for forgot-password (always the same shape to avoid email enumeration).</summary>
public class ForgotPasswordResponse
{
    public string Message { get; set; } = string.Empty;
    /// <summary>
    /// Only set when <c>PasswordReset:ReturnTokenInResponse</c> is true (local/dev). Never enable in production.
    /// </summary>
    public string? ResetToken { get; set; }
}

/// <summary>PUT /api/v1/auth/profile — self-service profile for Customer and Vendor.</summary>
...
public class DashboardStatsDto
{
    ...
    public int NarrationsToday { get; set; }
}
...
/// <summary>GET /api/v1/offlinepackages/catalog — public list of downloadable packages for mobile (Active only).</summary>
public class OfflinePackageCatalogItemDto
{
    public int Id { get; set; }
    public int LanguageId { get; set; }
    public string LanguageName { get; set; } = string.Empty;
...
public class WebVisitorNarrationRequest : WebVisitorPresenceRequest
{
    public int? PoiId { get; set; }
    public int? LanguageId { get; set; }
}
